...
class Table
{
  public:
     ...
     */
    void update_value_where(std::string value_column, std::string value, std::string condition_column,
                            std::string condition_value);

    /*
     * @brief Update a specific row value
     */
    void update_value_where_d(std::string value_column, std::string value, std::string condition_column1,
     ...
     */
    void delete_row_where_d(std::string condition_column1, std::string condition_value1, std::string condition_column2,
                            std::string condition_value2);
     ...
     * @return std::vector with row in it
     */
    std::vector<std::string> get_row_where_d(std::string condition_column1, std::string condition_value1,
