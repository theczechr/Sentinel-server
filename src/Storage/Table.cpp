...
void storage::Table::update_value_where(std::string value_column, std::string value, std::string condition_column,
...
void storage::Table::update_value_where_d(std::string value_column, std::string value, std::string condition_column1,
                                          std::string condition_value1, std::string condition_column2,
...
void storage::Table::delete_row_where_d(std::string condition_column1, std::string condition_value1,
...
std::vector<std::string> storage::Table::get_row_where_d(std::string condition_column1, std::string condition_value1,
                                                         std::string condition_column2, std::string condition_value2)
{
    ...
    std::vector<std::string> row;
    SQLite::Statement query(db.get_db(), "SELECT * FROM Accounts WHERE " + condition_column1 + " = '" +
